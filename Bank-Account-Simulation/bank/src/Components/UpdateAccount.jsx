    ...
    <div>
        ...
        }
        {
            error && "something went wrong..."
                    ...
                    <Grid templateColumns={{base:"repeat(1, 1fr)",md:"repeat(1, 1fr)",lg:"repeat(2, 1fr)"}} width='80%' justifyContent={'flex-start'} alignItems={'flex-start'} margin="auto"gap="20px"marginTop="20px"  w='full'>
                        {
                        products && products.length>0 && products.map((product)=>(
                            ...
                            >
                                ...
                                >
                                    ...
                                    {/* <Button m={1} onClick={onOpen}>Withdraw Money</Button> 
                                    <Button m={1} onClick={onOpen}>Deposit Money</Button>  */}
